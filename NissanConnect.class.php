...
#      	if ( $params['initial_app_strings'] = $this->config->initialAppStrings;
        $params['RegionCode'] = $this->config->country;
       	$params['lg'] = 'en-US';
        if ( $this->config->dcmID ) $params['DCMID'] = $this->config->dcmID;
       	if ( $this->config->vin ) $params['VIN'] = $this->config->vin;
